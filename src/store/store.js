...
export const store = configureStore({
  reducer: { openPopUpSlice, openTeamPopUpSlice, editTeamPopUpSlice , users: usersReducer, editUser: editUsersSlice , openAddUserFormPopUp, editLevelSlice,openPopupAddLevel},
});
