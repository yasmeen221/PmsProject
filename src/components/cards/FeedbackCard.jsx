...
const FeedbackCard = ({ feedback, date, dateIcon }) => {
  return (
    ...
    <a href="#" className="block max-w-96 max-h-230 p-0 mt-7 pb-4 bg-white border border-gray-200 rounded-lg relative hover:bg-hoverColor-baseHoverColor">
      <FeedbackButton buttonText="feedback" /> {/* Pass buttonText prop to FeedbackButton */}
    
      <div className="font-fontSize-sm text-gray-500 mt-16 mx-8">{feedback}</div>
