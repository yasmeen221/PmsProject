...
<label className={ label=="feedback" ? `bg-drawerColor-600 font-medium   text-buttonColor-baseColor py-3 px-2  rounded-b-lg w-[6.188rem] h-10 text-center hover:text-white hover:bg-buttonColor-baseColor`:`bg-buttonColor-900 text-buttonColor-800 py-3 px-2  font-medium  rounded-b-lg w-[6.188rem] h-10 text-center hover:bg-buttonColor-800
hover:text-white`}>{label}</label>
<div className="flex flex-col   w-full  gap-4  " >
<p className="w-full  text-sm text-slate-700  ">{text}</p>
<div className=" flex items-center  text-sm text-slate-400">
<span className="mr-2" >{< Icons.DateFeedbackIcon/>}</span><span>{date}</span>
</div>
</div>
