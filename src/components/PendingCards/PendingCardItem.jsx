    ...
    <div className=" flex flex-col justify-between w-[32%] h-[11.53rem]  border px-8 py-6  rounded-2xl  border-borderColor-100">
      <div className="flex justify-between  ">
        <div className=" items-center flex w-[60%] gap-x-1 ">
          ...
          <div className=" w-[75%]   ">
            <p className="font-md font-medium  text-sm w-[8.654rem]">sama ahmed</p>
      ...
      <div className="text-xs text-slate-700">I need your feedback on Competencies [ Team work, Communication and Public speaking ]</div>
    </div> //card
  );
}
